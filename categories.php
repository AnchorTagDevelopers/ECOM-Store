...
if($cat_id>0){
    if(isset($_GET['sort'])){
        ...
        if($sort=="price_high"){
            $sort_order=" order by product.saleprice desc ";
            $price_high_selected="selected";
        }if($sort=="price_low"){
            $sort_order=" order by product.saleprice asc ";
        ...
        $get_product=get_product($con,'latest',4, $cat_id,'','',$sort_order);
        }
else{
    $get_product=get_product($con,'latest',4, $cat_id);
}
